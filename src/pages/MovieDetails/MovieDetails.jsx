...
import ListWhite from '../../assets/svg/list_white.svg';
                ...
                <div className="relative xl:w-[70rem] 2xl:w-[74.875rem] h-[28.0625rem]">
                    <div className="w-full relative ">
                      {movie.backdrop_path ?
                        ...
                        alt={movie?.title}
                        loading="lazy" 
                        className="w-full h-50 md:h-96 ml-5 mt-4 rounded-2xl"/>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center mx-4">
                        <div className="flex items-center text-3 gap-none md:gap-1 mt-2 md:text-xl font-medium text-[#404040]">
                            ...
                            <div className="flex gap-2">
                                <p className="text-[#B91C1C] ml-4 p-2 lg:px-4 lg:py-0 border-2 border-solid border-[#F8E7EB] rounded-2xl text-sm">Action</p>
                    ...
                    <div className="mx-4 flex flex-col md:flex-row">
                      <div className="w-full md:w-65% text-3 md:text-4.5">
                        ...
                        <div className="flex items-center mt-16">
                          ...
                          <select name="" id="" className="w-full h-[3.4375rem] rounded-[0.625rem] border border-[#C7C7C7] bg-[rgba(255,255,255,0.80)] text-[#333] text-base xl:text-[1.25rem] font-medium px-4 flex justify-between items-center outline-none">
